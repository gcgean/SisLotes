...
exports.CreateTelegramConfig1700000000024 = void 0;
class CreateTelegramConfig1700000000024 {
    constructor() {
        this.name = "CreateTelegramConfig1700000000024";
    }
    ...
    `);
        ...
        await queryRunner.query(`ALTER TABLE telegram_config ADD COLUMN IF NOT EXISTS notificar_pagamento BOOLEAN NOT NULL DEFAULT TRUE`);
...
exports.CreateTelegramConfig1700000000024 = CreateTelegramConfig1700000000024;
