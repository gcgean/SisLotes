...
exports.AddRateioAndFornecedorLancamento1700000000032 = void 0;
class AddRateioAndFornecedorLancamento1700000000032 {
    constructor() {
        this.name = "AddRateioAndFornecedorLancamento1700000000032";
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE lancamentos_manuais ADD COLUMN IF NOT EXISTS id_fornecedor INTEGER`);
...
exports.AddRateioAndFornecedorLancamento1700000000032 = AddRateioAndFornecedorLancamento1700000000032;
