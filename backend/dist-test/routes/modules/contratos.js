...
exports.contratosRouter = void 0;
...
exports.contratosRouter = (0, express_1.Router)();
/** GET /api/contratos/venda/:id_venda
 *  Retorna todos os dados necessários para geração do contrato
 */
exports.contratosRouter.get("/venda/:id_venda", auth_1.requireAuth, async (req, res) => {
    ...
    const loteamRepo = data_source_1.AppDataSource.getRepository(Loteamento_1.Loteamento);
    ...
    // Venda
    const whereVenda = { id_venda: Number(id_venda) };
    if (idEmpresa)
    ...
    // Lote
    const whereLote = { id_lote: venda.id_lote };
    if (idEmpresa)
 ...
 */
exports.contratosRouter.get("/cliente/:id_cliente/vendas", auth_1.requireAuth, async (req, res) => {
