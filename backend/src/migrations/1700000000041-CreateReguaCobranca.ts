...
export class CreateReguaCobranca1700000000041 implements MigrationInterface {
  name = "CreateReguaCobranca1700000000041";
  ...
  async down(q: QueryRunner) { await q.query(`DROP TABLE cobranca_comunicacoes`); await q.query(`DROP TABLE cobranca_regras`); await q.query(`ALTER TABLE clientes DROP COLUMN email`); }
}
